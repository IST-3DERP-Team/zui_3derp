sap.ui.define([ 
	...
	return {
        ...
        setSmartFilterModel(oThis) {
            ...
            var me = oThis;
            var oModel = me.getOwnerComponent().getModel("StyleHeaderFilters");               
        ...
        onSmartFilterCustomControlValueHelp: function(oEvent) {
            ...
            this._oSmartFilterCustomControlValueHelpDialog = sap.ui.xmlfragment("zui3derp.view.fragments.searchhelps.SmartFilterCustomControlValueHelpDialog", this);
